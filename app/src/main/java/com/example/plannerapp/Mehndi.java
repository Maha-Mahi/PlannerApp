...
public class Mehndi extends AppCompatActivity implements Dialogue.DialogueListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_mehndi2 );
        ...
        view1=findViewById(R.id.viewidsahar );
        view2=findViewById( R.id.romanviewid );
        meet1=findViewById( R.id.meetidsahar);
        meet2=findViewById( R.id.romanmeetid );


        view1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(Mehndi.this,saharmehndi.class);
        ...
        view2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(Mehndi.this,romanmehndi.class);
                startActivity(intent1);
            }
        });
    ...
    public void applytext(final String timemeet, final String datemeet) {
        Toast.makeText( Mehndi.this,"Moving you to your Inbox",Toast.LENGTH_LONG ).show();
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if(meet1.isEnabled()) {
                        ...
                        Toast.makeText( Mehndi.this, "Message Send", Toast.LENGTH_LONG ).show();
