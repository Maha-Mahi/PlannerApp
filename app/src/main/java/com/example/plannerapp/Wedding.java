...
public class Wedding extends AppCompatActivity implements Dialogue.DialogueListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view1=findViewById(R.id.darviewid );
        view2=findViewById( R.id.ideaviewid );
        meet1=findViewById( R.id.darmeetid );
        meet2=findViewById( R.id.ideameetid );


        view1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(Wedding.this,darphoto.class);
        ...
        view2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(Wedding.this,ideaphoto.class);
                startActivity(intent1);
            }
        });
    ...
    public void applytext(final String timemeet, final String datemeet) {
        Toast.makeText( Wedding.this,"Moving you to your Inbox",Toast.LENGTH_LONG ).show();
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if(meet1.isClickable()) {
                        ...
                        Toast.makeText( Wedding.this, "Message Send", Toast.LENGTH_LONG ).show();
                        finish();
                    }
                    if (meet2.isClickable()){
                        //sms sending to the vendor
