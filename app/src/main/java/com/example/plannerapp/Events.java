...
public class Events extends AppCompatActivity implements Dialogue.DialogueListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view1=findViewById(R.id.ajviewid );
        view2=findViewById( R.id.fazeeiewid );
        meet1=findViewById( R.id.ajmeetid );
        meet2=findViewById( R.id.fazeemeetid );


        view1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(Events.this,ajphoto.class);
        ...
        view2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(Events.this,fazeephoto.class);
                startActivity(intent1);
            }
        });
    ...
    public void applytext(final String timemeet, final String datemeet) {
        Toast.makeText( Events.this,"Moving you to your Inbox",Toast.LENGTH_LONG ).show();
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if(meet1.isEnabled()) {
                        ...
                        Toast.makeText( Events.this, "Message Send", Toast.LENGTH_LONG ).show();
                        finish();
                    }
                    if (meet2.isEnabled()){
                        //sms sending to the vendor
